...
function shareOverrideOGMeta()
{
    ...
    FB.ui({
            ...
            action_properties: JSON.stringify({
                object: {
                    'og:url': "https:\/\/www.musicmindproject.com\/?id=" + userID,
                    'og:title': "The personal music track of " + username,
                    'og:description': "Our music is generated by MusicMind using data about the personality of each user",
                    'og:image': "https://www.musicmindproject.com/image/" + filePath + ".png"
                }
            })
        },
        function (response) {
